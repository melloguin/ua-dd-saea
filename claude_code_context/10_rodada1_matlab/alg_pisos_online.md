...
| NSGA-II, NSGA-III, MOEA/D, SMS-EMOA (online) | Tamanho de população | Compartilhado (pisos) | **~20** (varredura 10–50) | Protocolo Knowles/ParEGO — MOEA puro no orçamento minúsculo se calibra reduzindo a população | Como orçamento = pop×gerações é fixo, reduzir a pop dá ao baseline sua melhor chance; gerações = 31D−1 ÷ pop |
