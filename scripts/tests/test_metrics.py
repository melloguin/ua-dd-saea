...
class TestBoundsNormalize(unittest.TestCase):
    ...
    def test_selo_provisorio_vazio_apos_ratificacao(self):
        # [REAL-2.15 RATIFICADA, autor 2026-08-22] a fase 2 do DDMOP7 foi computada
        # e a régua [0;0]/468-690 ratificada ⇒ o selo SAIU. Tripwire invertido:
        # nenhum problema pode estar selado sem decisão nova registrada.
        self.assertNotIn("DDMOP7", metrics.REGUAS_PROVISORIAS)
        self.assertEqual(metrics.REGUAS_PROVISORIAS, {})
