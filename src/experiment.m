...
function [status, info] = run_c217(alg, problema, semente, exp, dataRoot)
    ...
    man.params = struct( ...
        ...
        'treino', "TrainIn = subamostra 3/4 estratificada do arquivo (§17.2)", ...
        'surrogate', "PNN par-a-par (spread 0.1925), score ternario {-1,0,+1}", ...
...
function [status, info] = run_b4(alg, problema, semente, exp, dataRoot)
    ...
    man.sigma_dict = struct( ...
        ...
        ... % [I-2] A REGRA DO ROTULO VERDADEIRO. Medido no proprio b4 sobre as
        ... % MESMAS 280 geracoes, as 3 definicoes plausiveis dao acuracia
        ... % 0,350 / 0,999 / 0,995 — "acuracia do classificador" nao e um numero
        ... % enquanto a regra nao estiver escrita. O AUC e robusto (~0,72).
        'REGRA_DO_ROTULO', "o b4 (CSEA) classifica um candidato contra as K=6 " + ...
            ...
            "'nao e pior que TODAS as 6 referencias' (prevalencia real medida " + ...
            "65,5%, acuracia 0,350, AUC 0,716). As outras 2 leituras testadas " + ...
            "('domina ao menos 1 ref' -> prevalencia 0,00%, acuracia 0,999; " + ...
            "'nao e dominado por nenhuma' -> 0,40%, acuracia 0,995) NAO sao a " + ...
            "regra do algoritmo: elas medem outra coisa e inflam o numero. " + ...
