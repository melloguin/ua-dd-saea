...
def _create_population_from_arrays(X, F):
    """Create a list of Individual objects from decision vectors and fitness."""
    population = []
    for i in range(len(X)):
        ind = Individual(X[i].tolist())
        ind.fitness = F[i].tolist()
