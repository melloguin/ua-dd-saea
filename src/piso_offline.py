...
def _run(exp, problema, semente, *,
    ...
    try:
        ...
        #    processo EXTERNO (PROBLEMAS_FINAL_POS_HOC — DDMOP7): ⑦ POS-HOC
        #    via scripts/final_eval.py (precedente e103), declarada no ⑤/⑥.
        ...
        if final_pos_hoc:
            ...
            # empates proximos e reprova uma ⑦ correta (bug medido no
            # b5m/ZDT1; docstring do write_final).
            H.write_final(
        ...
        res = H.write_run_outputs(
            ...
            # [T15.7b] ⑦ pos-hoc ⇒ a declaracao canonica no params
            # (`nd_final`), a MESMA gramatica do e103.
            params=(dict(_params_efetivos(n_ds), nd_final=FINAL_POS_HOC_INFO)
                    if final_pos_hoc else _params_efetivos(n_ds)),
